  ...
  return (
    ...
    >
      ...
      >
        <Reveal>
          <a
            ...
            className="group block overflow-hidden border border-line bg-surface transition-colors duration-300 hover:border-line-hover"
          >
      ...
      >
        ...
        <Reveal delay={1}>
          <h3 className="mt-4 text-[clamp(1.75rem,3.5vw,3rem)] font-bold tracking-tight text-primary">
            {project.name}
          </h3>
        </Reveal>
